...
public class SoundManager : MonoBehaviour {
    ...
    private void Awake() {
        ...
        volume = PlayerPrefs.GetFloat(PLAYER_PREFS_EFFECTS_VOLUME, 1f);
    }
    ...
    private void Start() {
        ...
        TrashCounter.OnAnyObjectTrashed += TrashCounter_AnyObjectTrashed;
    }

    private void TrashCounter_AnyObjectTrashed(object sender, System.EventArgs e) {
